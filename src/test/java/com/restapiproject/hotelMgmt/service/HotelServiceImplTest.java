...
public class HotelServiceImplTest {
	...
	void testCreateHotel() {
		...
		verify(hotelDao, times(1)).save(hotel1);    // ensures that the service actually called DAO once
		                                            // behavioral check
	}
	...
	void testUpdateHotel_Success() {
     ...
     void testUpdateHotel_Failure() {
    	 ...
    	 Hotel updateHotel = new Hotel(null, "Hotel A Updated", "Adddress Update", 15, 8, new BigDecimal("150.00"));
